  ...
  return (
    ...
    <section className='px-5 lg:px-0'>
        ...
        <form action="">
            ...
            <div className="lg:w-[60%] w-full flex flex-wrap justify-between">
                ...
                <div className="w-[48%] border-b-[1px] border-[#F0F0F0] mt-5">
                    ...
                    <input type="email" required placeholder='company@domain.com' className='font-dmsans text-[14px] font-normal text-[#767676] outline-none w-full h-[20px]'/>
        ...
        <form action="">
            ...
            <div className="lg:w-[60%] w-full flex flex-wrap justify-between">
                <div className="w-[48%] border-b-[1px] border-[#F0F0F0] mt-5">
                    ...
                    <input type="password" required placeholder='Password' className='font-dmsans text-[14px] font-normal text-[#767676] outline-none w-full h-[20px]'/>
        ...
        <div className="">
            ...
            <div className="mt-5">
                <button className='font-dmsans text-[14px] font-bold text-white py-[16px] px-[77px] bg-[#262626]'>Sign up</button>
            </div>
        </div>
